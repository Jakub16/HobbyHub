...
namespace HobbyHub.Application.UnitTests.RequestHandlers.Events.DeleteEventMember;

public class DeleteEventMemberCommandHandlerTests
{
    private Mock<IHobbyHubRepository> _repository;
    private Mock<ILogger> _log;
    private DeleteEventMemberCommandHandler _sut;
    ...
    public void SetUp()
    {
        ...
        _sut = new DeleteEventMemberCommandHandler(_repository.Object, _log.Object);
    }
    ...
    public async Task HandleShouldReturnFailureWhenUserDoesNotExist()
    {
        ...
        var result = await _sut.Handle(new DeleteEventMemberCommand(1, 1), CancellationToken.None);
    ...
    [Test]
    public async Task ShouldHandleDeleteEventMemberCommand()
    {
        _repository.Setup(r => r.UsersRepository.GetUserByIdAsync(1, CancellationToken.None))
            .ReturnsAsync(User);
