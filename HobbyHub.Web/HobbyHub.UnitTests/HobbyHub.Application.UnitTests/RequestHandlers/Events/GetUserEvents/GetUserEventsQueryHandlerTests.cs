...
namespace HobbyHub.Application.UnitTests.RequestHandlers.Events.GetUserEvents;
...
public class GetUserEventsQueryHandlerTests
{
    ...
    private GetUserEventsQueryHandler _sut;
    ...
    public void SetUp()
    {
        ...
        _sut = new GetUserEventsQueryHandler(_repository.Object, _mapper.Object, _log.Object);
    }
    ...
    public async Task HandleShouldReturnFailureWhenUserDoesNotExist()
    {
        ...
        var result = await _sut.Handle(new GetUserEventsQuery(1), CancellationToken.None);
    ...
    [Test]
    public async Task ShouldHandleGetUserEventsQuery()
    {
        ...
        _repository.Setup(r => r.EventsRepository.GetUserEvents(It.IsAny<int>(), CancellationToken.None))
            .ReturnsAsync(Events);
