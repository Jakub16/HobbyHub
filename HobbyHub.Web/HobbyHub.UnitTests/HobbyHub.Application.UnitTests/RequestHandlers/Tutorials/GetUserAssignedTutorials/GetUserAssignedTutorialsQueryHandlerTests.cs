...
namespace HobbyHub.Application.UnitTests.RequestHandlers.Tutorials.GetUserAssignedTutorials;

public class GetUserAssignedTutorialsQueryHandlerTests
{
    private Mock<IHobbyHubRepository> _repository;
    private Mock<ITutorialMapper> _tutorialMapper;
    private Mock<IMapper> _mapper;
    private Mock<ILogger> _log;
    private GetUserAssignedTutorialsQueryHandler _sut;
    ...
    public void SetUp()
    {
        ...
        _sut = new GetUserAssignedTutorialsQueryHandler(_repository.Object, _tutorialMapper.Object, _mapper.Object, _log.Object);
    }
    ...
    public async Task ShouldHandleGetUserTutorialsQuery()
    {
        ...
        _repository.Setup(repository => repository.TutorialsRepository
                .GetUserAssignedTutorials(It.IsAny<int>(), CancellationToken.None))
        ...
        var result = await _sut.Handle(new GetUserAssignedTutorialsQuery(1), CancellationToken.None);
