...
namespace HobbyHub.Application.UnitTests.RequestHandlers.Marketplace.GetUserOrderedMarketplaceItems;

public class GetUserOrderedMarketplaceItemsQueryHandlerTests
{
    private Mock<IHobbyHubRepository> _repository;
    private Mock<IMarketplaceItemMapper> _marketplaceItemMapper;
    private Mock<IMapper> _mapper;
    private Mock<ILogger> _logger;
    private GetUserOrderedMarketplaceItemsQueryHandler _sut;
    ...
    public void SetUp()
    {
        ...
        _sut = new GetUserOrderedMarketplaceItemsQueryHandler(_repository.Object, _marketplaceItemMapper.Object, _mapper.Object, _logger.Object);
    }
    ...
    public async Task HandleShouldReturnFailureWhenUserDoesNotExist()
    {
        ...
        var result = await _sut.Handle(new GetUserOrderedMarketplaceItemsQuery(1), CancellationToken.None);
    ...
    public async Task ShouldHandleGetUserOrderedMarketplaceItemsQuery()
    {
        ...
        _repository.Setup(repository => repository.MarketplaceItemsRepository
                .GetUserOrderedMarketplaceItems(1, CancellationToken.None))
