...
namespace HobbyHub.Application.UnitTests.RequestHandlers.Marketplace.GetUserCreatedMarketplaceItems;

public class GetUserCreatedMarketplaceItemsQueryHandlerTests
{
    private Mock<IHobbyHubRepository> _repository;
    private Mock<IMarketplaceItemMapper> _marketplaceItemMapper;
    private Mock<IMapper> _mapper;
    private Mock<ILogger> _logger;
    private GetUserCreatedMarketplaceItemsQueryHandler _sut;
    ...
    public void SetUp()
    {
        ...
        _sut = new GetUserCreatedMarketplaceItemsQueryHandler(_repository.Object, _marketplaceItemMapper.Object, _mapper.Object, _logger.Object);
    }
    ...
    public async Task HandleShouldReturnFailureWhenUserDoesNotExist()
    {
        ...
        var result = await _sut.Handle(new GetUserCreatedMarketplaceItemsQuery(1), CancellationToken.None);
    ...
    [Test]
    public async Task ShouldHandleGetUserCreatedMarketplaceItemsQuery()
    {
        ...
        _repository.Setup(repository => repository.MarketplaceItemsRepository
                .GetUserMarketplaceItems(1, CancellationToken.None))
